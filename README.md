...
Only the minimum files required to run MAME are included in this repository.

If additional files are required for your setup, please obtain them from the **official MAME distribution/source**.
